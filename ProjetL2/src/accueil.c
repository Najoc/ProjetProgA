...
void affichage_accueil(SDL_Renderer* renderer, Accueil* a, int mouseX, int mouseY) {
    ...
    if (collisions_point_rect(mouseX, mouseY, PLAY_X, PLAY_Y, PLAY_WIDTH, PLAY_HEIGHT))
        offplay = 40;
    ...
    renderElement(renderer,a->jouer, 0, 0 + offplay, PLAY_WIDTH, PLAY_HEIGHT, PLAY_X, PLAY_Y , PLAY_WIDTH, 50);
